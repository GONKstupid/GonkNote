...
internal static class LocGerman
{
    public static readonly Dictionary<string, string> Texts = new()
    {
        ...
        ["Menu.View.Keyboard"] = "_Bildschirmtastatur",
        ["Menu.View.Keyboard.Builtin"] = "Eingebaut",
        ["Menu.View.Keyboard.System"] = "System-Tastatur",
        ["Menu.View.Keyboard.Off"] = "Aus",
        ["Keyboard.SystemHint"] = "GonkNote ruft beim Antippen eines Textfelds den eingestellten Befehl auf. Vorgabe wird beim Start gesucht (z. B. omarchy-toggle-osk).",
        ["Keyboard.NoCommand"] = "Es wurde kein Befehl für eine System-Bildschirmtastatur gefunden. Trage ihn in {0} ein — eine Zeile, sonst nichts.",
        ["Menu.View.Theme"] = "_Dark/Light Mode umschalten",
        // ---- Eigene Designs (Nutzerwunsch 2026-08-02, gebaut 2026-09-10) ----
        ["Menu.View.Design"] = "_Design",
        ["Menu.View.Design.Light"] = "Hell",
        ["Menu.View.Design.Dark"] = "Dunkel",
        ["Menu.View.Design.Load"] = "Eigenes laden…",
        ["Menu.View.Design.Template"] = "Vorlage speichern…",
        ["Menu.View.Design.Folder"] = "Design-Ordner öffnen",
        ["Theme.LoadTitle"] = "Design laden",
        ["Theme.Filter"] = "Design-Datei",
        ["Theme.TemplateName"] = "{0} (Kopie)",
        ["Theme.TemplateSaved"] = "Die Vorlage steht in:\n{0}\n\nÖffne sie in einem Texteditor, ändere die Farbwerte und lade sie über „Design → Eigenes laden…“. Was du weglässt, kommt aus Hell bzw. Dunkel.",
        ["Theme.Broken"] = "Diese Datei lässt sich nicht als Design lesen:\n{0}",
        ["Theme.LoadFailed"] = "„{0}“ lässt sich nicht als Design laden:\n\n{1}",
        ["Theme.Err.Json"] = "Die Datei ist kein gültiges JSON: {0}",
        ["Theme.Err.Empty"] = "Die Datei ist leer.",
        ["Theme.Err.Variant"] = "Es fehlt die Angabe, ob das Design hell oder dunkel ist. Erwartet wird \"variant\": \"light\" oder \"dark\" — gefunden wurde „{0}“.",
        ["Theme.Err.Color"] = "„{1}“ ist keine Farbe (bei „{0}“). Erwartet wird #RGB, #RRGGBB oder #AARRGGBB.",
